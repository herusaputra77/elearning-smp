						...
						<?php foreach ($tugas as $m) { ?>
							...
							<div class="col-md-12 col-md-6">
								<div class="features-item second-feature wow fadeInUp animated" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible;-webkit-animation-duration: 1s; -moz-animation-duration: 1s; animation-duration: 1s;-webkit-animation-delay: 0.2s; -moz-animation-delay: 0.2s; animation-delay: 0.2s;">
									...
									<a href="<?= base_url('assets/tugas/' . $m['file_tugas']) ?>" target="_blank">
										<div class="icon"></div>
									</a>
									<h4>Tugas Tanggal <?= date('d M Y', $m['waktu_kirim_tugas']) ?></h4>
									<div class="line-dec"></div>
									<p><?= $m['deskripsi_tugas'] ?>, <a href="<?= base_url('siswa/tugas/detail_tugas/' . $m['id_tugas']) ?>">Detail Tugas</a></p>
									<p><a href="<?= base_url('assets/tugas/' . $m['file_tugas']) ?>" style="" target="_blank">Klik Disini</a> untuk mendownload TUGAS</p>
								</div>
							</div>
						<?php } ?>
